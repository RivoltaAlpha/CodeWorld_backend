...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "projectCategoryAssignments" (
	"id" serial PRIMARY KEY NOT NULL,
	"project_id" integer NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "work_logs" ADD CONSTRAINT "work_logs_user_id_users_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projectCategoryAssignments" ADD CONSTRAINT "projectCategoryAssignments_project_id_projects_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("projects_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projectCategoryAssignments" ADD CONSTRAINT "projectCategoryAssignments_category_id_categories_category_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("category_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
